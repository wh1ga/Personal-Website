export default {
    en: {
        ...
        experience: [
            {
                place: `Provizor.me, Moscow (remotely) - Mobile App for Pharmacists`,
                worktitle: `Software Engineer`,
            ...
            {
                place: `Randomizer - Web App for social network`,
                worktitle: `Creator and Owner`,
                dates: `2015-06 - present`,
                highlights: [
                    "Full Stack development (PHP, MySQL, JavaScript, CSS)",
                    "App has 5-star rating (over 5000 votes).",
                    "App has over 1500 unique daily visitors.",
                ]
            },
            {
        ...
        education: {
            place: `Novgorod State University Polytechnic College`,
        ...
        certifications: [
            { date: `2016-08`, title: `Principles of Machine Learning, Microsoft Corporation through edX` },
            { date: `2016-10`, title: `Applied Machine Learning, Microsoft Corporation through edX` },
        ],
    },
    ru: {
        headers: {
        ...
        experience: [
            {
                place: `Provizor.me, Москва (удалённо) - Мобильное приложение для фармацевтов`,
                worktitle: `Full Stack разработчик`,
                dates: `04.2019 - н.в.`,
                highlights: [
            ...
            {
                place: `Рандомайзер - Веб приложение для социальной сети`,
                worktitle: `Создатель и Владелец`,
                dates: `06.2015 - н.в.`,
                highlights: [
                    "Full Stack разработка приложения. (PHP, MySQL, JavaScript, CSS)",
                    "Приложение имеет рейтинг 5 звёзд (более 5000 голосов).",
                    "Приложение имеет более 1500 уникальных посетителей в день.",
                ]
            },
            {
        ...
        education: {
            title: `Политехнический колледж НовГУ`,
            place: `Программное обеспечение вычислительной техники и автоматизированных систем.`,
        ...
        languages: [
            "Русский (Родной язык)",
            "Английский (С1 - продвинутый уровень)",
        ],
        certifications: [
            { date: `2016-08`, title: `Принципы машинного обучения, Microsoft Corporation through edX` },
            { date: `2016-10`, title: `Прикладное машинное обучение, Microsoft Corporation through edX` },
        ]
    }
